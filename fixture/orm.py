...
class ORMFixture:
    ...
    def convert_groups_to_model(self, groups):
        def convert(group):
            return Group(id=str(group.identifier), name=group.name, header=group.header, footer=group.footer)
    ...
    def convert_contacts_to_model(self, contacts):
        def convert(contact):
            return Contact(id=str(contact.identifier), firstname=contact.firstname, lastname=contact.lastname)
